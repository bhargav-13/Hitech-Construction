...
const ROLE_META: Record<UserRole, { icon: React.ComponentType<{ size?: number }>; tint: string }> = {
  Admin: { icon: ShieldCheck, tint: "bg-teal-50 text-teal-600" },
...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-brand-accent/10 via-background to-teal-100/40 p-4">
