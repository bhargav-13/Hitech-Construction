    ...
    crewTasks.forEach((task, i) => {
      ...
      rows.push(
        <div
          ...
          className="relative m-1 flex h-7 items-center justify-center overflow-hidden rounded bg-indigo-500 text-xs font-medium text-white"
        >
          <div
            className="absolute top-0 left-0 h-full bg-indigo-700/70"
