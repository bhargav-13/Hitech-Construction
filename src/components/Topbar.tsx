...
export function Topbar({ title }: { title: string }) {
  ...
  // The project scope dropdown sits beside every page title — compulsory across modules (Vyapar
  // included), except the Projects screens themselves, which already are the project list / a
  // single project.
